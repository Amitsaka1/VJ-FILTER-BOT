...
PICS = (environ.get('PICS', 'https://envs.sh/s/abZYt7QvriMC5boknWrS-w/A3Q.jpg')).split() #SAMPLE PIC
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002219128829').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001722510868') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002489559469')).split()]
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movierequest56bot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ott_up_date')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/movierequest56bot')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'movierequest56bot') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://vj-filter-bot-vn7d.onrender.com/")
